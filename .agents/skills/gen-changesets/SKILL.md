...
4. If an ignored internal package change enters the CLI bundle, put `oh-my-kimi-code` in frontmatter instead of mixing the ignored package into the same changeset.
